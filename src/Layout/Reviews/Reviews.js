...
import ReviewSlider from './ReviewSliders';
import Image from '../../UI/Image';
import Button from '../../UI/Button';

//IMAGE FILES
import SliderMove from '../../assets/images/Union.svg';
import SliderDots from '../../assets/images/Ellipse.svg';
    ...
    return (
      <Section className={classes.Reviews}>
        ...
        <div className={`${classes.row} ${classes.SliderBtn}`}>
          ...
          <div className={`${classes.col} ${classes.SliderControls}`}>
